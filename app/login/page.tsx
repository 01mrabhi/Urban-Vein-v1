    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4 sm:p-8 selection:bg-red-600/30">
      <div className="w-full max-w-[1200px] h-[800px] bg-[#0f0f0f] rounded-[2.5rem] overflow-hidden flex shadow-2xl shadow-black/50 border border-zinc-900">
        ...
        <div className="w-full lg:w-1/2 p-12 sm:p-16 lg:p-24 flex flex-col justify-center relative">
          ...
          <h1 className="text-4xl font-bold text-white mb-8 tracking-tight">Welcome Back</h1>
          ...
          <div className="flex flex-col items-center gap-3 mb-6">
            <button
              ...
              className="w-14 h-14 rounded-2xl bg-[#1a1a1a] hover:bg-zinc-800 border border-zinc-800 flex items-center justify-center transition-all hover:scale-110 shadow-lg active:scale-95 group"
            >
            ...
            <span className="text-[9px] font-black uppercase tracking-widest text-zinc-600">1-Click Google Access</span>
          </div>
          ...
          <div className="relative flex items-center justify-center mb-6">
            ...
            <div className="relative bg-[#0f0f0f] px-4 text-[9px] font-black tracking-widest uppercase text-zinc-600">
          ...
          <form className="space-y-5" onSubmit={handleLogin}>
            ...
            <div className="flex items-center justify-between pt-1">
              ...
              <Link href="/forgot-password" className="text-xs font-bold text-zinc-400 hover:text-white transition-colors">Forgot Your Password?</Link>
            </div>
