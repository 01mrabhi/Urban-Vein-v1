...
import { EyeOff, Eye, Apple, Facebook } from 'lucide-react';
        ...
        <div className="w-full lg:w-1/2 p-12 sm:p-16 lg:p-24 flex flex-col justify-center relative">
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-2">
              ...
              <input 
                ...
                className="w-full bg-white text-black px-4 py-3.5 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-red-600 transition-shadow placeholder:text-zinc-500 font-medium"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input 
                  ...
                  placeholder="••••••••" 
                  className="w-full bg-white text-black px-4 py-3.5 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-red-600 transition-shadow placeholder:text-zinc-500 font-bold tracking-widest"
                />
                <button 
                  type="button" 
            ...
            <button 
              type="submit" 
              className="w-full bg-[#ff1a1a] hover:bg-red-600 text-white font-black tracking-[0.2em] uppercase text-sm py-4 rounded-full mt-4 transition-all shadow-[0_0_20px_rgba(255,26,26,0.3)] hover:shadow-[0_0_30px_rgba(255,26,26,0.5)] active:scale-[0.98]"
            >
              Login
            </button>
          </form>
          ...
          <div className="mt-12">
            ...
            <div className="flex justify-center gap-4">
              <button className="w-12 h-12 rounded-full bg-[#1a1a1a] flex items-center justify-center hover:bg-zinc-800 hover:scale-105 transition-all text-white border border-zinc-800">
                <Apple size={20} className="fill-white" />
              </button>
              <button className="w-12 h-12 rounded-full bg-[#1a1a1a] flex items-center justify-center hover:bg-zinc-800 hover:scale-105 transition-all text-blue-500 border border-zinc-800">
                <Facebook size={20} className="fill-blue-500" />
              </button>
              <button className="w-12 h-12 rounded-full bg-[#1a1a1a] flex items-center justify-center hover:bg-zinc-800 hover:scale-105 transition-all border border-zinc-800">
