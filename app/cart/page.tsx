                ...
                <div className="sticky top-32 space-y-8">
                  <div className="bg-zinc-900/50 border border-zinc-900 rounded-[3rem] p-10 space-y-10 relative overflow-hidden group">
                    ...
                    <div className="space-y-4">
                      ...
                      <Link 
                        href="/checkout"
                        className="w-full bg-red-600 text-white py-6 rounded-3xl font-black uppercase tracking-[0.2em] text-xs flex items-center justify-center gap-3 shadow-2xl shadow-red-600/30 hover:bg-red-500 transition-all active:scale-95 group"
                      >
