      ...
      >
        ...
        <header className="space-y-6">
          <div className="flex items-center justify-center gap-4">
             ...
             <span className="text-[10px] font-black uppercase tracking-[0.5em] text-zinc-500">Payment Confirmed</span>
             <Sparkles size={16} className="text-red-600" />
          </div>
          ...
          <p className="text-zinc-500 text-sm font-bold uppercase tracking-widest leading-relaxed italic max-w-md mx-auto">
            Your transmission has been verified. Your high-grade gear is now entering the assembly phase.
          </p>
        </header>
        ...
        <div className="bg-zinc-950/50 border border-zinc-900 rounded-3xl p-8 space-y-6 text-left relative overflow-hidden group">
          ...
          {paymentId && (
            <div className="pb-6 border-b border-zinc-900 space-y-1">
              <p className="text-[8px] font-black uppercase tracking-widest text-zinc-600 italic flex items-center gap-1">
                <ShieldCheck size={12} className="text-green-500" /> Razorpay Payment Reference
              </p>
              <p className="text-xs font-mono font-bold text-red-500 tracking-wider">{paymentId}</p>
            </div>
          )}
          ...
          <div className="grid grid-cols-2 gap-8 pt-2">
             <div className="space-y-1">
               ...
               <p className="text-[10px] font-black uppercase tracking-widest text-white">WITHIN 48 HOURS</p>
             </div>
             <div className="space-y-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
           ...
           >
             <Truck size={16} className="group-hover:translate-x-1 transition-transform" /> View Orders
           </Link>
           <Link 
             href="/#shop"
